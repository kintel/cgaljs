...
CONFIGURE_CMD = ' '.join([
    ...
    '-DCMAKE_TOOLCHAIN_FILE=/home/marcosscriven/sources/cgaljs/components/cgal/cmake-emcc-toolchain.txt',
...
ARTIFACTS =  {
    ...
    'libs': [
        ...
        {'source': 'CGAL-%s/lib/libCGAL.so' % VERSION,'name':'libcgal_core.so'},
    ]
}
